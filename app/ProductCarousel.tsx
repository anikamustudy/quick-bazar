...
const ProductCarousel: React.FC = () => {
  return (
    <div> 
        {/*Auction */}
    <div className="  p-4 bg-white rounded-lg shadow-md justify-center w-full max-w-screen-lg mx-auto px-6 flex flex-col space-y-2">
      {/* Header Section */}
      ...
      <div className="relative ">
        ...
        <div className="flex overflow-x-auto gap-4 scrollbar-hide">
          {products.map((product) => (
            <div
              key={product.id}
              className="flex-shrink-0 w-64 bg-gray-100 rounded-lg shadow-md"
            >
              <img
              ...
              <div className="p-3">
                ...
                <p className="text-gray-500 text-xs justify-right items-right ">{product.location}</p>
        ...
        {/* Next Button */}
        <button
          className="absolute right-0 top-1/2 -translate-y-1/2 bg-gray-200 hover:bg-gray-300 text-black rounded-full w-8 h-8 flex justify-center items-center z-10"
          aria-label="Next"
        >
          ›
        </button>
